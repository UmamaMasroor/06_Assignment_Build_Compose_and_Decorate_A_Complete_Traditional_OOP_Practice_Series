...
student:Student = Student("Ali",79)
print(student.name)
print(student.marks)
print(f"Hi! I'm {student.name} and I got {student.marks} marks in my third quarter of GIAIC exam.")     
...
print(MathUtils.add(2,1))
print(MathUtils.add(20,56))
print(MathUtils.add(6,10))
print(MathUtils.add(2,9))
print(MathUtils.add(6,89))
print(MathUtils.add(58,29))
...
# Create a class Employee with: a public variable name, a protected variable _salary, and a private variable __ssn.
...
teacher1:Teacher = Teacher("Fatima","Spanish")
